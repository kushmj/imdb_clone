...
SECRET_KEY = 'django-insecure-de)l4iq&_c(r$xm8$s2fiivp1eed01dh&e*$f2r8zsha3rk=mx'
...
# create logg to save the info

REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework_simplejwt.authentication.JWTAuthentication',
    ],
    "DEFAULT_FILTER_BAKCKENDS" : ['django_filters.rest_framework.DjangoFilterBackend']
}
...
LOGGING = {
    ...
    'handlers' : {
        'file' : {
            ...
            'filename' : os.path.join(BASE_DIR, 'imdb.log'),
...
# DEFAULT_FROM_EMAIL = 'kushmj99@gmail.com'
